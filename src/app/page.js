      ...
      <main className="flex-1 w-full">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-white flex justify-center">
          <div className="container px-4 md:px-6 flex flex-col items-center">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12 place-items-center">
              <motion.div whileHover={{ y: -5 }} className="grid gap-1 rounded-lg border bg-white p-6 shadow-sm text-center">
